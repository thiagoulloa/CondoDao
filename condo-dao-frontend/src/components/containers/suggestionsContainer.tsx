...
export const SuggestionsContainer = ({
  ...
  return (
    <div className="w-full h-[50%] bg-[#313131] flex flex-col items-center justify-center rounded-4xl py-6 px-6 gap-4">
      <p className="text-2xl font-bold text-[#AAAAAA]">Sugestões</p>
